...
import { MatCell, MatCellDef, MatColumnDef, MatHeaderCell, MatHeaderCellDef, MatHeaderRow, MatHeaderRowDef, MatRow, MatRowDef, MatTableDataSource, MatTable } from "@angular/material/table";
...
@Component({
  standalone: true,
  imports: [
    HttpClientModule, CommonModule, MatCard, MatCardContent, MatTable, MatColumnDef,
    MatHeaderCell, MatCell, MatHeaderCellDef, MatCellDef, MatCardHeader, MatCardTitle,
    MatDivider, NgForOf, NgIf, MatFormField, MatHeaderRow, MatHeaderRowDef, MatInput,
    MatLabel, MatPaginator, MatRow, MatRowDef, MatSlideToggle, MatSort, MatSortHeader,
...
export class AttributeComponent implements OnInit, AfterViewInit {
  ...
  goBack(): void {
    this.router.navigateByUrl("/admin/hsid").then(r => true);
  }
  ...
  openDialog(element: any): void {
    ...
    this.router.navigate(['admin/attribute'], { queryParams: { elementnumber: element.elementNumber } });
  }
